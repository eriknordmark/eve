...
const (
	// defaultInitialEVEVersion is the small-geometry release the escripts bring
	// the device up on (prep-kvm-to-k-topology.sh BRINGUP_EVE_VER).
	defaultInitialEVEVersion = "12.1.0"
