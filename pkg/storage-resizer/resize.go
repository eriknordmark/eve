...
func cmdShrink(args []string) int {
	...
	flagFile := fs.String("flag-file", "", "read the target from this file if present and non-empty (e.g. /config/shrink-persist); overrides --shrink-to")
