...
rootfs measures 288,174,080 bytes under it, with master's `40fb331bc rootfs: use
1MB squashfs blocks on amd64/kvm` setting the block size that gets it there.
